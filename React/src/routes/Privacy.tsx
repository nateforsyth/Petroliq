    ...
    let htmlElement: JSX.Element =
        <main className={`subheadingElement`}>
            <div>
                ...
                <p><b>How do you exercise your rights?</b> The easiest way to exercise your rights is by visiting <a href="https://app.dreamsof.dev/Profile" target="_blank">your Profile page</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
                ...
                <p>To exercise these rights, you can contact us by visiting <a href="https://app.dreamsof.dev/Profile" target="_blank">your Profile page</a>, by visiting <a href="https://app.dreamsof.dev/Contact" target="_blank">your Contact page</a>, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
                ...
                <p>To submit a request to exercise these rights described above, please email <a href="mailto:info@dreamsof.dev">info@dreamsof.dev</a> or visit <a href="https://app.dreamsof.dev/Profile" target="_blank">your Profile page</a>.</p>
                ...
                <p>If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it. If you wish to appeal our decision, please email us at <a href="mailto:info@dreamsof.dev">info@dreamsof.dev</a> . Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may contact the <a href="https://www.oag.state.va.us/consumer-protection/index.php/file-a-complaint" target="_blank">Attorney General</a> to submit a complaint.</p>
                ...
                <p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: <a href="https://app.dreamsof.dev/Profile" target="_blank">your Profile page</a>.</p>
